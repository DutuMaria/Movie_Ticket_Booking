using MovieTicketBooking.BLL.Helpers;
using MovieTicketBooking.BLL.Interfaces;
using MovieTicketBooking.BLL.Managers;
using MovieTicketBooking.DAL;
using MovieTicketBooking.DAL.Entities;
//using MovieTicketBooking.DAL.Interfaces;
//using MovieTicketBooking.DAL.Repositories;
...
namespace MovieTicketBooking
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MovieTicketBooking", Version = "v1" });
            //});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, InitialSeed initialSeed)
        {
            if (env.IsDevelopment())
            {
                ...
                //app.UseSwagger();
                //app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MovieTicketBooking v1"));
            }
